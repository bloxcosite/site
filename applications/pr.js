...
function loadapp() {
    document.getElementById('mainForm').innerHTML = `<form action="https://docs.google.com/forms/d/e/1FAIpQLSfRt2uEkOQW1gl1LjptXoKy1YDPg-U6O2a41R2AF0ToZ3gUYQ/formResponse" method="post" target="sucessMessage" onsubmit="submitted = true">
...
<div id="q-areyoustaff">
  ...
  <label class="form-check-label" for="PartnershipTeam">Marketing Team</label><br>
</div>
...
<div id="q-shuarerere">
  ...
  <input type="radio" name="entry.1181452484" id="shuarerere" value="No" class="form-check-input">
  <label for="shuarerere">No, I do not agree.</label><br>
</div>
<!-- Question share app status -->
